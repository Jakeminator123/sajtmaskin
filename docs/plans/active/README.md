...
**Aktiv (huvuddrivlinje 2026-07-13)** — Stabilisering: F3-env-gate (**ny P1** M#f3env1, kodverifierad), en verify-ägare per F2-version (M#vlane1–2 + BB#299, prod-bevisad), domän-PR (#486 a–c + BB#deploy4, kodverifierade), review-freshness, verification-invalidation + svansar från det raderade lokala kördokumentet `builder-stabilisering` (F3-kravyta-slut, env-scope-fallback, `configured`-init, single-canary) → plan [`2026-07-13-stabilisering-verify-f3-doman-plan.md`](2026-07-13-stabilisering-verify-f3-doman-plan.md).
...
Levererat (2026-07-09, PR #456): Publicera-stringensplan — publicera/deploy + F3-integrationer stringentare (ReleaseGate-lås, domänlås, deploy-repair-loop, inspectorUrl/felstate, RAG-härdning, terminologi) + kompletteringspass A#12/A#5/A#3. Kvar: bug-backlog `BB#deploy4–5` (i [`BUG-SWARM-BACKLOG.md`](../../../BUG-SWARM-BACKLOG.md); `BB#deploy2` stängdes i #469, `BB#deploy3` i #456) → [`../avklarat/2026-07-08-publicera-stringens-plan.md`](../avklarat/2026-07-08-publicera-stringens-plan.md).
