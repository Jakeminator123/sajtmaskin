...
| M | [`OPEN-THREADS-SCAFFOLDS-2026-04-24.md`](./OPEN-THREADS-SCAFFOLDS-2026-04-24.md) + [`SEO-F3-PROMOTION-NEXT-PR.md`](./SEO-F3-PROMOTION-NEXT-PR.md) | 7 trådar från scaffolds + telemetri-bugjakt (SAJ-34→SAJ-59). **SEO-defaults vid Bygg/F3-promotion** ✅ KLAR 2026-04-26 (PR #102 docs + #103 PR-A + #105 PR-B → master `854bb9a31`); kvar parkerat: brand-UI v2 + live-smoke polish. Övriga trådar oförändrade: scaffold-retry brief-context, matcher-kwNorm, scoring wire/keep/delete, scaffoldRetryUsed-upstream, sv-locale-routing, latency-mätning. | Låg–Medel |
