...
function main(): void {
  ...
  if (existing && sameCapabilities(existing.capabilities, capabilities)) {
    console.log(
  ...
  const next: CapabilityMap = {
    $comment:
      "View of capability → dossier ids. Auto-generated by scripts/dossiers/regenerate-capability-map.ts from data/dossiers/{hard,soft}/<id>/manifest.json. Do NOT edit by hand — run the script. Read-only at runtime; the registry walks data/dossiers/{hard,soft}/ directly.",
