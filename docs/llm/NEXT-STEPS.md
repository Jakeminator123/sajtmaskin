...
> Dokumentation: `docs/llm/egen-motor/README.md`
...
Se byggplan: `docs/llm/egen-motor/byggplaner/12-progressiv-preview.md`
...
Se byggplan: `docs/llm/egen-motor/byggplaner/09-embedding-sokning.md`

## Vad vi lärt oss av v0:s arkitektur

Från analysen i `docs/llm/egen-motor/analys/`:
...
Detaljerad bedömning: `docs/llm/egen-motor/scaffold-candidates.md`
