...
- [~] **Omr 2 `S3` statusresolver-invariant:** aktiverad som hård import-invariant i **6-3 punkt 2** (`status-resolver-single-writer.stability.test.ts`) + legacy-resolvern `resolveEngineVersionDisplayStatus` borttagen. Levererad i draft-PR (ej mergad).
