...
|---|---|---|
| Bug-kö | **Start här.** 6 aktiva rader. `SM-014`, `SM-018`, `SM-032`, `SM-038` och `SM-040` är arkiverade med mergebevis; `SM-007`/`SM-070` redovisas separat som flaggade releaseblockerare och `SM-071` väntar ny repro efter senare scaffoldändringar. | [`BUG-SWARM-BACKLOG.md`](../../../BUG-SWARM-BACKLOG.md) |
