...
- Sajttyp: Blogg
- Erbjudande eller idé: Hälsokällan är en blogg om hälsa, träning och välmående. Jag skriver om kost, yoga och mental hälsa.
- Befintlig hemsida: Börja från noll
- Huvudmål: Bygga förtroende och samla en publik
- Målgrupp: Alla målgrupper, hälsomedvetna personer 25-50 år
- Måste finnas med: Kontaktformulär
- Önskad känsla/stil: Rent och modernt

## Användarens egna formuleringar
1. Hälsokällan är en blogg om hälsa, träning och välmående. Jag skriver om kost, yoga och mental hälsa.
...
## SEO-metadata
- title: "Hälsokällan — Hälsokällan är en blogg om hälsa, träning och välmående" (anpassa per sida)
