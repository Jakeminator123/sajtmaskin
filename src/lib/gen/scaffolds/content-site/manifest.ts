...
export const contentSiteManifest: ScaffoldManifest = {
  ...
  label: "Content Site",
  description:
    "Content-heavy informational site with structured pages, sidebar navigation, FAQ, and documentation-style layout. For municipalities, schools, knowledge bases, and organizations.",
  ...
  promptHints: [
    "Use this scaffold for content-heavy informational sites: municipalities, schools, documentation, knowledge bases, FAQ sites.",
    "Keep the structured navigation and multi-page content layout.",
