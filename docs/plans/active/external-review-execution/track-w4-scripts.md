...
- [x] **Ev. manuella skript:** ~~`extract-static-core.mjs`~~ borttaget (B3-05, 2026-03-27). **`scaffold-pipeline.py`** flyttad till **`scripts/manual/scaffold-pipeline.py`** (B3-06); `scripts/README.md` + inventory uppdaterade.
