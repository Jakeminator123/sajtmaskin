...
|---|---|---|
| Inloggad Audit-nivåer | Recon av Vanlig vs Avancerad på startsidans Audit-yta (inte `/analys`). Båda nivåerna kör samma Sol-anrop, samma schema och samma scrape; Avancerad är i praktiken prompt + UI-gate + 10 credits. Expert är inventerad, inte byggd. Väntar ägarbeslut D1–D6. Ingen kod, prisändring eller migration i det här spåret. | [`2026-09-18-audit-nivaer/00-master-plan.md`](2026-09-18-audit-nivaer/00-master-plan.md) |
| Publik `/analys` via audit | Lead magnet på `/analys` + `POST /api/analys`, mergad till preview i #1471. Gratisvägen kör Luna/basic utan web_search. Inloggad `/api/audit` behåller Sol. Widget-spåret (punkt 2 av fem) är struket. Av de fem har inline bild i mejl/DM ett klart A/B-protokoll men inget kört experiment ([`K1`](2026-09-18-analys-audit-leadmagnet/aktiviteter/K1-inline-bild-ab-test.md)); PRV T-1 och nyemission är beställningar, DNS-bytet är PARK tills Radar v1 — [`resterande-fyra-spar.md`](2026-09-18-analys-audit-leadmagnet/resterande-fyra-spar.md). Utskick ägs av `JakobScrape`, inte av det här repot. Kvar i detta spår: index/sitemap (B2) och partner `?mode=audit` (B4). | [`2026-09-18-analys-audit-leadmagnet/00-master-plan.md`](2026-09-18-analys-audit-leadmagnet/00-master-plan.md) |
