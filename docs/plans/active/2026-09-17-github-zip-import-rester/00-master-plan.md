...
> **Status: PR2 forward-port mot dagens `preview`.** #1446 (`4dc192b88`) är
> stale/CONFLICTING och supersedas av den nya branchen. Ingen merge av den
> gamla branchen. Ingen produktionspromote.
...
| PR2 bilder + lokala fonts | **Forward-port:** extractorn skriver `base64:` + `language: "binary"`. Extra/för stora assets hoppas över mot preview-hostens transporttak (2/12 MiB) i stället för att fälla `start`. |
