...
| Generationslatens | [`2026-08-05-generationslatens/00-master-plan.md`](2026-08-05-generationslatens/00-master-plan.md) | Plan skriven 2026-08-05 på prod-mätning av fyra versioner: strömmen är 79–99 % av **strömfönstret** (inte av hela väntan — brief och orkestrering ligger före mätankaret), bildhämtning kostar noll, och verifierns 69 s var trippel-gatead av BuildSpec-klassningen (inte av autofix-risk — bugbot-fynd korrigerat före merge). Steg 2 fann klassningen **befogad** (multipage→premium, score≥3→heavy — ingen tröskeländring) och verifierade att brief + orkestrering ligger **före** mätankaret, så totalerna underskattar användarens väntan | **Steg 1 väntar på merge av PR #792** (telemetri: `meta` i `/logg`, `meta.streamMs`, `materialize_images`-fasen). Steg 3 (verifiern ur F2) är ett ägarbeslut, steg 4 (parallell codegen) en beslutspunkt som kräver ägar-OK |
