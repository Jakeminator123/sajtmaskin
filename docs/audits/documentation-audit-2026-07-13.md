...
| `docs/contracts/*.md`                                                     | Mänskliga kontrakt                             | Kod/schemas/policies per fil                | KEEP/REWRITE                     | Medel | 10 filer; ämnen behövs, enumlistor ska flyttas till generated                                        | 2–3    |
...
| `docs/operating/*.md`                                                     | Operativ referens                              | Backoffice/runtime                          | KEEP                             | Låg   | Tre filer, tydligt driftansvar                                                                       | 1      |
...
| `docs/external-pipelines/*.md`                                            | Borttagen extern pipeline                      | Git-historik                                | ARCHIVE/DELETE                   | Låg   | Pipeline borttagen 2026-07-09; får inte vara runtime-guide                                           | 3      |
...
| `docs/archive/status/STATUS-2026-04-20.md`                                | Cloud-loop-status                              | Git-historik                                | DELETE                           | Låg   | Bas-SHA `51751bd30`, Linear-status och borttagna paths; fyra historikcommits bevarar den             | 3      |
...
| `docs/plans/active/*.md`                                                  | Aktiva eller väntande planer                   | Pågående beslut                             | KEEP/REWRITE                     | Medel | Sju planer; backoffice-planen är uttryckligen stale                                                  | 3      |
...
| `docs/plans/avklarat/grandmaster/*.md`                                    | Levererad planhistorik                         | Runtime + git                               | ARCHIVE                          | Låg   | Genomförd och mergad; fortsatt beslutsvärde i masterplan/backlog                                     | 3      |
...
| `docs/plans/avklarat/kontrollflode/aktiviteter/*.md`                      | Engångsprompter                                | Git-historik                                | DELETE AFTER REFERENCE MIGRATION | Medel | `00-master-plan.md` länkar katalogen; cleanup måste först ersätta länken med git-/PR-historik        | 3      |
...
| `docs/plans/avklarat/stabilisering-2026-07/aktiviteter/*.md`              | Engångsprompter                                | Git-historik                                | DELETE AFTER REFERENCE MIGRATION | Medel | `00-master-plan.md` länkar katalogen; cleanup måste först ersätta länken och bevara beslutsevidens   | 3      |
| `docs/plans/avklarat/stort-framsteg-2026-07-03/2026-07-03_1058.md`        | Rå sessionsnotis                               | Slutrapport + git                           | DELETE                           | Låg   | Ingen direkt aktiv referens; slutrapporten behåller sammanställd evidens                             | 3      |
...
| `docs/plans/avklarat/*.md`                                                | Avslutade beslut/planer                        | Runtime + git                               | ARCHIVE                          | Låg   | Behåll beslut med fortsatt referensvärde; rensa rena handoffs separat                                | 3      |
...
| `docs/canvases/llm-flow-canvas.plan.md`                                   | Canvas-plan                                    | Canvas-script                               | ARCHIVE/DELETE                   | Låg   | Planen ska inte vara permanent runtime-guide                                                         | 3      |
...
| `config/ai_models/*.md`                                                   | Modelloperatörsdocs                            | Manifest + Zod-loader                       | REWRITE                          | Medel | Sex filer; inventarier bör genereras från manifest                                                   | 2      |
| `config/prompt-core/*.md`                                                 | Core Rules                                     | Prompt composer                             | KEEP                             | Hög   | Runtime-input, inte vanlig dokumentation                                                             | —      |
...
| DB + Blob parity      | Separat read-only PR/push-gate               | `.github/workflows/db-blob-sync-check.yml`                   |
