...
| Kostnadsfri-kampanjflödet | **Sidantal beslutat och implementerat i PR:n:** kampanjstandard 3 via strukturerad `pageCountHint`, med uttryckliga val på 1 eller 2 bevarade. Kvar som beslutsunderlag: bolagsdata från JakobScrape-dashen via befintlig `POST /api/kostnadsfri` med uttrycklig PII-gräns, och pre-generering vid lösenordsverifiering. Städningen av de tre taxonomikopiorna hänger på de kvarvarande besluten. | [`2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md`](2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md) |
