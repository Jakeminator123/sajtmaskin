...
const ENV_KEYS: EnvKeyDefinition[] = [
  ...
  { key: "V0_STREAMING_ENABLED", required: false, notes: "v0-only legacy feature flag" },
  ...
  { key: "UPSTASH_REDIS_REST_URL", required: false, notes: "Rate limits (primary)" },
  { key: "UPSTASH_REDIS_REST_TOKEN", required: false, notes: "Rate limits (primary)" },
  { key: "REDIS_URL", required: false, notes: "Redis cache (primary)" },
  { key: "KV_URL", required: false, notes: "Redis cache (legacy fallback)" },
  { key: "KV_REST_API_URL", required: false, notes: "Rate limits (legacy fallback)" },
  { key: "KV_REST_API_TOKEN", required: false, notes: "Rate limits (legacy fallback)" },
