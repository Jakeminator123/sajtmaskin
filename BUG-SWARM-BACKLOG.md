...
> **Plan: produkt** — alla rader nedan rör motormodellerna som betjänar användarsajter (own-engine/prompt-assist/Deep Brief). Meta-planet (Cursor-dev-agent-slug i `.cursor/commands/långbänk.md`) hanteras separat som doc-fix, inte som backlog-rad.
