...
(rör ej fysiskt; radering i område 8). [`C2`](aktiviteter/C2-ordlista-check.md) — ordlista/glossary-check
(push/PR/merge, warn-först). Övriga aktiviteter skapas när området är fullt på tur.
