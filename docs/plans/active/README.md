...
| Prod-körningens fynd — fokus dossiers | [`2026-08-05-prodkorning-dossiers/00-master-plan.md`](2026-08-05-prodkorning-dossiers/00-master-plan.md) | Diagnos 2026-08-05 + dossier-förenkling indexerad i [`../avklarat/README.md`](../avklarat/README.md). A1 (MapLibre) mergad i #828. A3/A4 har **öppen PR #839** (SM-023, stale-check av verifier-dom) — ej levererat förrän merge; SM-024-branch (`fix/sm024-diagnostic-only-deterministic-repair`) på väg upp parallellt | **Kvar:** A3/A4 tills #839 (+ SM-024) mergats; A5 är ägarbeslut. `02` (OpenClaw auto-send § B1, postcheck-racet § B2) och `03` (UX) kräver ägarens go per punkt (MVP-frys) |
## Ägarbeslut
