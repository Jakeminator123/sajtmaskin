...
|---|---|---|
| Publik `/analys` via audit | Lead magnet på `/analys` + `POST /api/analys`. Gratisvägen kör Luna/basic utan web_search; inloggad `/api/audit` behåller Sol. Draft-PR mot preview. | [`2026-09-18-analys-audit-leadmagnet/00-master-plan.md`](2026-09-18-analys-audit-leadmagnet/00-master-plan.md) |
