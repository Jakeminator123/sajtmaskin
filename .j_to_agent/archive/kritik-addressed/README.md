...
Här ligger **parallella granskningsfiler** (`NNpct-*.md` m.fl.) som har **slutits i kod/docs**: handoff-punkter genomförda eller ersatta av nyare progress.

| Fil | Flyttad / anteckning |
|-----|----------------------|
...
När en ny snapshot är helt åtgärdad: flytta filen hit och uppdatera tabellen + översikten i `KRITIK-OVERVIEW.md`.
