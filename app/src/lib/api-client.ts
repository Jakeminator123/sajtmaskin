 ...
 *
 * POST /api/validate-prompt → (används för pre-validering)
 *   - Input: prompt, hasExistingCode?
 *   - Output: intent, needsClarification, clarifyQuestion?
 *   - Snabb validering FÖRE generationen börjar
 *
