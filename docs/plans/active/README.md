...
| Kostnadsfri-kampanjflödet | **Beslut fattade, kod skriven (ej mergad).** Sidtak 3, allowlistad bolagsprofil → mini-wizard (aldrig prompten), bransch som hint mot de 11 id:na, taxonomiägare i `src/lib/builder/wizard-taxonomy.ts`, ingen verify-prewarm/spekulativ init. | [`2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md`](2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md) |
