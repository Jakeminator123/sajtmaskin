...
|---|---|---|
| Publik `/analys` via audit | Lead magnet på `/analys` + `POST /api/analys`, mergad till preview i #1471. Gratisvägen kör Luna/basic utan web_search. Inloggad `/api/audit` behåller Sol. Widget-spåret (punkt 2 av fem) är struket. Av de fem är inline bild i mejl/DM körbar nu ([`K1`](2026-09-18-analys-audit-leadmagnet/aktiviteter/K1-inline-bild-ab-test.md)); PRV T-1, nyemission och DNS-byte är beställningar i ordning — [`resterande-fyra-spar.md`](2026-09-18-analys-audit-leadmagnet/resterande-fyra-spar.md). Kvar i detta spår: index/sitemap (B2) och partner `?mode=audit` (B4). | [`2026-09-18-analys-audit-leadmagnet/00-master-plan.md`](2026-09-18-analys-audit-leadmagnet/00-master-plan.md) |
