...
| Allra svåraste reasoning där svaret är icke-trivialt | `claude-opus-4-8-thinking-max` | Bara när kvaliteten verkligen krävs — dyrt och långsamt |
