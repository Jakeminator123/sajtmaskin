...
|---|---|---|
| Kundens adress och portal | Portal-/databasgrund levererad; pilotförberedelser och export under slutverifiering. A3, domänflöde, abonnemang och aktivering återstår. Ingen produktionspromote. | [`2026-09-14-kundens-adress-och-portal/00-master-plan.md`](2026-09-14-kundens-adress-och-portal/00-master-plan.md) |
