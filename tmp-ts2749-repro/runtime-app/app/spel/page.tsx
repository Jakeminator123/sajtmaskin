      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col justify-center px-6 py-20">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3 text-sm text-white/75">
            <p>Path: /spel</p>
            <p>Preserve the existing Spel route unless the user explicitly asks to remove it.</p>
          </div>
          ...
          <CardContent className="space-y-4 p-6">
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-white/75">
                Preserve the existing Spel route unless the user explicitly asks to remove it.
              </p>
            </div>
            <div>
            ...
            <div className="rounded-xl border border-white/10 bg-black/10 p-4">
              ...
              <p className="mt-2 text-sm leading-relaxed text-white/80">
                Öppna sidan via navigationen och be sedan buildern att bygga ut spel fullt ut.
              </p>
            </div>
          </CardContent>
        </Card>
