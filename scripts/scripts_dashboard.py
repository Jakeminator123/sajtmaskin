...
class ScriptsDashboard:
    ...
    def _build_explanation_panel(self, parent: ttk.Frame) -> None:
        ...
        llm_lines = [
            ...
            "",
            "Viktig fail-fast-regel i finalize:",
            "- partial-file-output (t.ex. snippets, avhuggna importblock eller ofullständiga file=\"...\"-block) blockeras nu före versionssave",
            "- repair-/autofix-prompten kräver nu kompletta filer, inte snippets",
            "",
    ...
    def _build_terms_panel(self, parent: ttk.Frame) -> None:
        ...
        lines = [
            ...
            "- previewPending = preview-start forvantas",
            "- previewUrlHint = temporar VM-hint under boot, inte persisterad previewUrl",
            "- preview-ready / build-error = faktisk startsignal",
            "- preview-session / preview-status = bootstrap + recover for chat+version",
            "",
            "Användning i kedjan:",
