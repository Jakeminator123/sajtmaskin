...
Font pairings remain prompt-level guidance; scaffold starter files default to Inter + `--font-sans`. Deterministic variant→code font injection is a planned improvement (see [`docs/plans/active/2026-08-04-restlista-llm-polish.md`](../plans/active/2026-08-04-restlista-llm-polish.md)).
