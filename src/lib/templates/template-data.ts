// Template catalog data: categories, quick prompts, and v0 template gallery items.
// Data source is generated by scripts/template-library/sync-v0-templates.mjs,
// which prefers templates_v0/out manifests and falls back to v0.app discovery.
...
export interface Template {
  ...
  previewImageUrl: string; // External URL for the template card preview image
  category: string;
}
