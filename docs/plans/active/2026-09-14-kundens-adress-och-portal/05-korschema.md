...
A3:s förberedande draft är #1369, inte full A3. A1: DNS remätt 2026-09-15,
fortfarande NXDOMAIN för `sites.*`; inte driftklart. SHA-bunden lägesbild:
[HANDOFF.md](HANDOFF.md). C2 och D2/D3:s kund-/driftflöden återstår.
