...
module.exports = {
  ...
  __testing: {
    ...
    setInstallShellRunnerForTesting: packageInstall.setInstallShellRunnerForTesting,
    runInstallCommandWithFallback: packageInstall.runInstallCommandWithFallback,
    ...
    listFreshPreviewHmrViewers: shared.listFreshPreviewHmrViewers,
    acknowledgeFreshPreviewHmrViewers: shared.acknowledgeFreshPreviewHmrViewers,
    listLivePreviewHmrViewers: shared.listLivePreviewHmrViewers,
    acknowledgeLivePreviewHmrViewers: shared.acknowledgeLivePreviewHmrViewers,
    signalPreviewClientReloadAfterHotPatch: shared.signalPreviewClientReloadAfterHotPatch,
    markHotPatchWritten: shared.markHotPatchWritten,
    getHotPatchWrittenAt: shared.getHotPatchWrittenAt,
    clearHotPatchWritten: shared.clearHotPatchWritten,
    markPreviewDocumentServed: shared.markPreviewDocumentServed,
    getPreviewDocumentServedAt: shared.getPreviewDocumentServedAt,
    clearPreviewDocumentServedAt: shared.clearPreviewDocumentServedAt,
    isPreviewSocketFreshAfterPatch: shared.isPreviewSocketFreshAfterPatch,
    ...
    acknowledgePreviewClientDocument: shared.acknowledgePreviewClientDocument,
    ...
    refreshWorkspaceAfterAdoptedPatch: processLifecycle.refreshWorkspaceAfterAdoptedPatch,
    takeRestartBootsQueuedForTesting: processLifecycle.takeRestartBootsQueuedForTesting,
    writeFilesIntoWorkspace: workspaceFiles.writeFilesIntoWorkspace,
