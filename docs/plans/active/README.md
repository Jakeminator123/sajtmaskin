...
|---|---|---|
| Kundens adress och portal | C1/C2/C3e1/A2/A3(#1386)/B1/D1 är kod på preview. C2 utan kill-switch; A3-redirect och branded av. D3-adapter saknas. A1/A4 och D2/D3 (#1385) återstår. #1389 är post-promotion. Ingen produktionspromote. | [`2026-09-14-kundens-adress-och-portal/00-master-plan.md`](2026-09-14-kundens-adress-och-portal/00-master-plan.md) |
