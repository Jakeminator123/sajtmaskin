...
interface PreviewPanelFrameProps {
  isLoading: boolean;
  iframeError: boolean;
...
// tidigare "slow boot"-raden (N6/Del C) togs bort — se project-phase-priorities.mdc.
  ...
  return (
    ...
    >
      ...
      */}
      ...
      {/*
        `preview_ready_timeout` är en MISSTANKE, inte ett bevis. Ägarbeslut
        2026-09-01 (chat 5efde3c4): visa ingen banner och ingen overlay —
        recovery + telemetri lever kvar i usePreviewIframe. Övriga iframe-fel
        (dokument oläsbart, transportfel) behåller den heltäckande overlayen.
      */}
