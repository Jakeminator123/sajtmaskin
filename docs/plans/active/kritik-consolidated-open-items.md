...
|----|-------------------------|-------------|-----|------|--------|
| K-007 | `78pct-r`, `64pct-s`, progress | W2-rester: deploy auto-fix / hårdare valideringsfas före deploy (valfritt produktbeslut) | kod / produkt | hög | [ ] — **delmoment 2026-03-26:** `GET` readiness spärrar om `package.json` i versionen är **ogiltig JSON** (samma klass som deploy-preflight `invalidFiles`); se `version-file-integrity.ts` |
