...
export function deriveTemplateRuntimeGuidance(
  ...
  if (entry.signals.pricing || entry.recommendedScaffoldFamilies.includes("saas-landing")) {
  ...
  if (entry.signals.ecommerce || entry.recommendedScaffoldFamilies.includes("ecommerce")) {
  ...
  if (entry.signals.blog || entry.recommendedScaffoldFamilies.includes("blog")) {
  ...
  if (entry.signals.portfolio || entry.recommendedScaffoldFamilies.includes("portfolio")) {
  ...
  if (entry.signals.auth || entry.recommendedScaffoldFamilies.includes("auth-pages")) {
  ...
  if (entry.signals.docs || entry.signals.cms || entry.recommendedScaffoldFamilies.includes("content-site")) {
