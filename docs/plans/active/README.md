...
| Kostnadsfri-kampanjflödet | **Underlag, inga beslut fattade.** Sidantal (3 vs 4–5), bolagsdata från JakobScrape-dashen via befintlig `POST /api/kostnadsfri` med uttrycklig PII-gräns, och pre-generering vid lösenordsverifiering. Städningen av de tre taxonomikopiorna hänger på besluten. | [`2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md`](2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md) |
