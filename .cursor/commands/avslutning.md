...
- Om `backoffice/`, `config/dashboard/app.py` eller `sajtmaskin_backoffice.py` berörs: synka även delad helperlogik i `backoffice/shared.py` (och legacy re-exports vid behov) så att ytorna inte driver isär.
