...
| Låser en konkret fixad bugg | Pekar på en **konkret** bugg: en öppen rad i `BUG-SWARM-BACKLOG.md § Aktiv kö`, eller en avslutad `[x]`-rad i samma fils `## Arkiv` (äldre bulk-arkiv = git). |
