...
4. Starta read-only subagenter sparsamt:
   ...
   - Använd modell `cursor-grok-4.5-high-fast` om en explicit modell väljs (scan-rollen i [`.cursor/README.md § Modellval för subagenter`](../README.md#modellval-för-subagenter-kanonisk-tabell)).
