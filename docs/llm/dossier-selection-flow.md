...
**Källtruth:** `src/lib/gen/dossiers/select.ts` + `src/lib/gen/system-prompt.ts`. **Schema:** `docs/schemas/strict/dossier.schema.json`. **Operativ guide:** `docs/operating/dossier-cheatsheet.md`. **Uppdaterad:** 2026-04-21.
