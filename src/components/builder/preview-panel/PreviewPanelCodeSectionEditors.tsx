  ...
  return (
    ...
    {metadataDraft && editableMetadata ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {metadataSaveError ? (
            <div className="text-xs text-destructive">{metadataSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {heroDraft && editableHeroContent ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {heroSaveError ? (
            <div className="text-xs text-destructive">{heroSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {serviceItemsDraft && editableServiceItems ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {servicesSaveError ? (
            <div className="text-xs text-destructive">{servicesSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {faqItemsDraft && editableFaqItems ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {faqSaveError ? (
            <div className="text-xs text-destructive">{faqSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {testimonialItemsDraft && editableTestimonialItems ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {testimonialsSaveError ? (
            <div className="text-xs text-destructive">{testimonialsSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {teamMembersDraft && editableTeamMembers ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {teamSaveError ? (
            <div className="text-xs text-destructive">{teamSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {statItemsDraft && editableStatItems ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {statsSaveError ? (
            <div className="text-xs text-destructive">{statsSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {processStepsDraft && editableProcessSteps ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {processSaveError ? (
            <div className="text-xs text-destructive">{processSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {productItemsDraft && editableProductItems ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {productsSaveError ? (
            <div className="text-xs text-destructive">{productsSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {pricingCardsDraft && editablePricingCards ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {pricingSaveError ? (
            <div className="text-xs text-destructive">{pricingSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {pricingFeatureCardsDraft && editablePricingFeatureCards ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {pricingFeaturesSaveError ? (
            <div className="text-xs text-destructive">{pricingFeaturesSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {categoryItemsDraft && editableCategoryItems ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {categorySaveError ? (
            <div className="text-xs text-destructive">{categorySaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {navItemsDraft && editableNavItems ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {navSaveError ? (
            <div className="text-xs text-destructive">{navSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {buttonLabelsDraft && editableButtonLabels ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {buttonLabelsSaveError ? (
            <div className="text-xs text-destructive">{buttonLabelsSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {blogPostsDraft && editableBlogPosts ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {blogPostsSaveError ? (
            <div className="text-xs text-destructive">{blogPostsSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {footerLinkGroupsDraft && editableFooterLinkGroups ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {footerLinksSaveError ? (
            <div className="text-xs text-destructive">{footerLinksSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    {contactDraft && editableContactDetails ? (
      <div className="rounded-md border border-border bg-muted/60 p-3">
        ...
        <div className="grid gap-3">
          ...
          {contactSaveError ? (
            <div className="text-xs text-destructive">{contactSaveError}</div>
          ) : null}
        </div>
      </div>
    ) : null}
    ...
    {rawEditMode ? (
      <div className="space-y-2">
        ...
        />
        {rawCodeSaveError ? (
          <div className="text-xs text-destructive">{rawCodeSaveError}</div>
        ) : null}
      </div>
    ) : (
      <CodeBlock
