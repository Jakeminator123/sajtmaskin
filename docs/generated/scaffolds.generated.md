...
>
> Source: `src/lib/gen/scaffolds/registry.ts`
> Source: `src/lib/gen/scaffolds/*/manifest.ts`
> Generator: `scripts/docs/generate-contract-docs.mjs`

# Scaffolds

This catalog contains 10 runtime-registered scaffolds after registry defaults and research overrides are applied.
...
| `projekt-bas-app` | Projekt bas-app | `app`       | `simple`   | `app`, `website`             | `routing-basics`, `component-ready`                  | 4             |
| `saas-landing`    | SaaS Landing    | `marketing` | `medium`   | `website`, `template`        | `pricing`, `feature-grid`, `comparison`, `cta`       | 7             |
