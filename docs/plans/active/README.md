...
| Kostnadsfri-kampanjflödet | **Alla tre besluten fattade; inget i `master`.** Sidantal (kampanjstandard 3 via strukturerad `pageCountHint`, uttryckliga val på 1–2 bevarade) levererat till `preview` via #1370. Bolagsdatans PII-gräns beslutad och ingesten byggd med allowlist, org.nr-validering och konstant felutdata — i PR. Pre-generering avgjord: ingen spekulativ init vid lösenordsverifiering. Wizardens förifyllning och taxonomins lib-ägare (`src/lib/builder/wizard-taxonomy.ts`) ligger i den här staplade PR:n. Kvar: `preview`→`master`. | [`2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md`](2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md) |
