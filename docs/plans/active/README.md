...
|---|---|---|
| Kundens adress och portal | **Reviderat MVP-förslag för granskning.** Branded pilot, BYOD, kundportal, export och abonnemang per sajt. Fyra svarsförslag; ingen drift eller betalning aktiveras av plan-PR:n. | [`2026-09-14-kundens-adress-och-portal/00-master-plan.md`](2026-09-14-kundens-adress-och-portal/00-master-plan.md) |
