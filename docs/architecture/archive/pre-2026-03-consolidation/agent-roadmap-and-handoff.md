...
**Uppdatering 2026-03:** Öppen backlog och Plan 17 samlas i **en** fil: [`docs/plans/active/PROJECT-STATE-AND-DIRECTION.md`](../../../plans/active/PROJECT-STATE-AND-DIRECTION.md). Tidigare `17-repo-separation-and-independence.md`, `MASTER-ALLT-KVAR.md`, m.fl. finns i **git-historik** om du behöver långa äldre tabeller.

| Plan file | Status | Notes |
|------|--------|-------|
| *Plan 17 / repo separation* | `active` (kanon §8 i capstone) | [`PROJECT-STATE-AND-DIRECTION.md`](../../../plans/active/PROJECT-STATE-AND-DIRECTION.md) §8 — tidigare separat `17-repo-separation-and-independence.md` arkiverad genom sammanslagning. |
