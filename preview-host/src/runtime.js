...
module.exports = {
  ...
  __testing: {
    ...
    inspectInjectionScriptSrc: previewProxy.inspectInjectionScriptSrc,
    APP_ORIGINS: previewProxy.APP_ORIGINS,
    INSPECT_SCRIPT_ORIGIN: previewProxy.INSPECT_SCRIPT_ORIGIN,
