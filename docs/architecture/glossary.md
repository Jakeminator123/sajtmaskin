...
| Preview-förvärmning | Default-av latensoptimering som kan väcka preview-hosten och överlappa baseline-installationen med en ny chats första riktiga codegen-körning. Publicerar ingen preview-URL och är aldrig en readiness-signal. Kod: `preview-prewarm.ts`; env: `SAJTMASKIN_PREVIEW_PREWARM`. |
