      ...
      <div className="relative z-10 flex-1 overflow-y-auto scroll-smooth" data-scroll-container>
        ...
        <section className="flex flex-col items-center justify-center px-6 pt-10 pb-8 md:pt-16 md:pb-12 min-h-[calc(100vh-57px)]">
          ...
          <div className="w-full max-w-2xl animate-fade-up" style={{ animationDelay: "0.6s" }}>
            {isRecording && (
              <div className="mb-3 input-3d bg-secondary/80 backdrop-blur-xl rounded-full border border-border/50 px-6 py-3 shadow-2xl animate-in slide-in-from-bottom-2 fade-in duration-300">
                <div className="flex items-center justify-between gap-6">
                  <div className="flex items-center gap-2 shrink-0">
                    <div className="w-2 h-2 rounded-full bg-destructive animate-pulse" />
                    <p className="text-sm font-medium text-foreground">Spelar in...</p>
                  </div>
                  <div className="flex-1 flex items-center justify-center gap-[2px] h-10 overflow-hidden">
                    {[...Array(60)].map((_, i) => (
                      <div
                        key={i}
                        className="voice-wave-bar-horizontal bg-primary/70 rounded-full shrink-0"
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-8 w-8 rounded-full bg-secondary/30 hover:bg-destructive/20 text-foreground hover:text-destructive"
                    ...
                    <Button
                      size="icon"
                      className="h-8 w-8 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl"
                      onClick={() => setIsRecording(false)}
                      aria-label="Bekr\u00e4fta inspelning"
                    >
