        ...
        <div className="mx-auto max-w-3xl px-6 py-16">
          ...
          <div className="prose-sm space-y-8">
            <Section title="1. Om tjänsten">
              <p>
                Sajtmaskin (&quot;Tjänsten&quot;) är en AI-driven plattform för webbplatsgenerering
                som drivs av Pretty Good B.V., Nederländerna (&quot;Bolaget&quot;, &quot;vi&quot;).
            ...
            <Section title="2. Användarkonto">
              <p>
                Du ansvarar för att hålla dina inloggningsuppgifter säkra. Du får inte dela ditt
                konto med andra. Vi förbehåller oss rätten att stänga konton som missbrukas.
              </p>
            </Section>

            <Section title="3. Credits och betalning">
              <p>
                Tjänsten använder ett credit-baserat system. Credits köps via Stripe och kan
                användas för att generera webbplatser och AI-funktioner. Köpta credits återbetalas
                inte om inget annat avtalas. Priserna anges inklusive moms om inget annat
                specificeras.
              </p>
              <p>
                För särskilda testinbjudningar gäller de kostnadsfria genereringar och eventuella
                testpriser som anges i erbjudandet. Testvillkor innebär inte någon automatisk
                prenumeration. Fortsatt generering, hosting och domän kan ha separata kostnader.
              </p>
              <p>
                Om ett tekniskt fel hos oss orsakat en felaktig debitering, kontakta
                support@sajtmaskin.se. Vi utreder felet och försöker i största möjliga mån
                återställa credits eller återbetala avgiften för den berörda genereringen. Detta är
                ett undantag från huvudregeln om köpta credits ovan och begränsar inte rättigheter
            ...
            <Section title="4. Genererat innehåll">
              <p>
                ...
                genererat innehåll är fritt från fel, immaterialrättsliga intrång eller
                säkerhetsbrister. Du ansvarar för att granska och anpassa genererat material innan
                publicering.
              </p>
            </Section>
            ...
            <Section title="6. Ansvarsbegränsning">
              <p>
                ...
                indirekta skador, utebliven vinst eller förlust av data. Vår maximala
                ansvarsskyldighet är begränsad till det belopp du betalat till oss under de senaste
                12 månaderna.
              </p>
            </Section>
