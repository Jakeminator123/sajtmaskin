...
- Erbjudande eller idé: Vi driver en frisörsalong som heter Klipp & Stil i Göteborg. Vi erbjuder klippning, färgning, styling och skäggvård.
- Befintlig hemsida: Börja från noll
- Huvudmål: Få fler kunder att boka tid
- Målgrupp: Kvinnor 25-55 år, lokala kunder i Göteborg
- Måste finnas med: Bokning online, Bildgalleri, Priser och paket
- Önskad känsla/stil: Varmt och personligt

## Användarens egna formuleringar
1. Vi driver en frisörsalong som heter Klipp & Stil i Göteborg. Vi erbjuder klippning, färgning, styling och skäggvård.
...
## SEO-metadata
- title: "Klipp & Stil — Vi driver en frisörsalong som heter Klipp & Stil i Göteborg" (anpassa per sida)
