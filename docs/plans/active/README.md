...
| Kostnadsfri-kampanjflödet | **Sidantal beslutat och levererat på `preview` i #1370 (`53daaa6ebc6766f4cd919f1e792af4162d53aaf0`):** kampanjstandard 3 via strukturerad `pageCountHint`, med uttryckliga val på 1 eller 2 bevarade. Kvar som beslutsunderlag: bolagsdata från JakobScrape-dashen via befintlig `POST /api/kostnadsfri` med uttrycklig PII-gräns, och pre-generering vid lösenordsverifiering. Städningen av de tre taxonomikopiorna hänger på de kvarvarande besluten. | [`2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md`](2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md) |
