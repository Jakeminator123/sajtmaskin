...
|---|---|---|
| Kundens adress och portal | Portal-/databasgrund, pilotförberedelser och export levererade på preview. A3, domänflöde, abonnemang och faktisk aktivering återstår. Ingen produktionspromote. | [`2026-09-14-kundens-adress-och-portal/00-master-plan.md`](2026-09-14-kundens-adress-och-portal/00-master-plan.md) |
...
| Reparationskedjan | **Aningen flytande — underlag, inte godkänt arbetspaket.** Färsk prod-mätning 2026-09-11: 12 av 19 fallna typechecks advisory-promotas, `TS2604`/`TS1005` saknas i render-risklistan, publiceringsvägen kör aldrig ReleaseGate för designversioner. Fyra föreslagna steg i ordning; inget påbörjat. | [`2026-09-11-reparationskedjan/00-master-plan.md`](2026-09-11-reparationskedjan/00-master-plan.md) |
...
| Kostnadsfri-kampanjflödet | **Alla tre besluten fattade; inget i `master`.** Sidantal (kampanjstandard 3 via strukturerad `pageCountHint`, uttryckliga val på 1–2 bevarade) levererat till `preview` via #1370 (`53daaa6eb`). Bolagsdatans PII-gräns och ingest levererad till `preview` via #1372. Pre-generering avgjord: ingen spekulativ init vid lösenordsverifiering. Wizardens förifyllning och taxonomins lib-ägare (`src/lib/builder/wizard-taxonomy.ts`) ligger i den här PR:n. Kvar: `preview`→`master`. | [`2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md`](2026-09-14-kostnadsfri-kampanjflode/00-master-plan.md) |
