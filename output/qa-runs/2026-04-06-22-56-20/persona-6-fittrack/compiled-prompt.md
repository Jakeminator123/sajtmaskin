...
- Sajttyp: Landningssida
- Erbjudande eller idé: FitTrack är en ny app för träningsplanering och kostuppföljning. Vi lanserar snart.
- Befintlig hemsida: Börja från noll
- Huvudmål: Samla leads inför lansering
- Målgrupp: Unga vuxna 18-35 år som tränar regelbundet
- Måste finnas med: Kontaktformulär
- Önskad känsla/stil: Lekfullt med mycket färg

## Användarens egna formuleringar
1. FitTrack är en ny app för träningsplanering och kostuppföljning. Vi lanserar snart.
...
## SEO-metadata
- title: "FitTrack — FitTrack är en ny app för träningsplanering och kostuppföljning" (anpassa per sida)
