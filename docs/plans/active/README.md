...
**Levererat (2026-07-12, PR #498/#499/#500):** Dossier-grupper (10 st, presentations-lager) + fallback-kontrakt — terminologi/docs, gruppmapp 9→10, CI-invariant (skärpt per-dossier: **varje** hard-dossier ⇒ `mock ≠ none` eller capability-undantag), backoffice-kategorivy med lägg-till/radera, catalog/API-röktest. **Etapp 7 (F3-runtime-kontrakt) UPPLÅST med ägar-OK 2026-07-12** — blockers under fix (P1 ReleaseGate TOCTOU, `BB#f3det1/2`; capability-provenance ägarbeslutad-deferred) → [`../avklarat/2026-07-12-dossier-grupper-och-fallback-kontrakt.md`](../avklarat/2026-07-12-dossier-grupper-och-fallback-kontrakt.md).
