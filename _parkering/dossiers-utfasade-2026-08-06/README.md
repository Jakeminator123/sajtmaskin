...
Fem hard-dossiers parkerade vid dossier-förenklingen (ägarens fria-händer-uppdrag
...
- Capabilities `error-tracking`, `image-generation`, `realtime` och
  ...
  (vercel-analytics). En gammal snapshot som ännu bär ett utfasat capability-id
  selekterar tyst ingenting (befintligt beteende för okända capabilities), och
  ett F3-godkännande av providern går den generiska LLM-vägen
