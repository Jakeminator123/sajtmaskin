...
**Status:** W1–W5 **execution** enligt denna mapp + track-filer är **avslutad** — se [REMEDIATION-EXIT.md](./REMEDIATION-EXIT.md). **Vad som återstår** efter exit: [REMAINING-WORK.md](../../active/REMAINING-WORK.md). **Historisk W1–W5-text:** [Workload snapshot (arkiverad)](../orchestrator-workloads-external-review.md) (kort pekare i [Aktiv pekare (stub)](../../active/orchestrator-workloads-external-review.md)).
...
| [kritik-consolidated-open-items.md](../../active/kritik-consolidated-open-items.md) | **Kritik:** samlad master-tabell (ersätter spridda `NNpct-*.md`; [kritik-derived-backlog](../../active/kritik-derived-backlog.md) pekar hit) + konfliktrisk mot integration/deploy-spåret |
