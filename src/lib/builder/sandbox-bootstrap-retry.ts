/**
 * Client-side retry policy for POST `/api/v0/chats/.../sandbox-preview` (bootstrap).
...
export const SANDBOX_BOOTSTRAP_RETRY_FALLBACK_MS = 6_000;
...
export function parseRetryAfterMs(
  headers: Headers,
  fallbackMs = SANDBOX_BOOTSTRAP_RETRY_FALLBACK_MS,
): number {
...
export type SandboxBootstrapRetryInput = {
  httpStatus: number;
 ...
 */
export function shouldRetrySandboxBootstrapFetch(input: SandboxBootstrapRetryInput): boolean {
