// Prompt Assist model registry + provider resolution.
// Kept separate from `promptAssist.ts` (addendum builders) so callers that only
// need model-allowlist / provider routing can import this without pulling the
// ~800-line prompt-assist surface.
