...
|---|---|---|
| Kundens adress och portal | Portal-/databasgrund, pilotförberedelser och export levererade på preview. A3, domänflöde, abonnemang och faktisk aktivering återstår. Ingen produktionspromote. SHA-handoff 2026-09-15. | [`00-master-plan.md`](2026-09-14-kundens-adress-och-portal/00-master-plan.md) · [`HANDOFF.md`](2026-09-14-kundens-adress-och-portal/HANDOFF.md) |
