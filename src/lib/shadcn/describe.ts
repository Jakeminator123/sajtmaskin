 ...
 * - The pure search/match engine lives in `registry-search.ts` (shared with the
 *   Fas 4 generation-path resolver); this module re-exports it so its public
...
// Re-export the shared search engine so existing consumers/tests of this
// module's public API are unaffected by the registry-search.ts extraction.
export {
  loadDescribeCommunityRegistries,
  matchCommunityItems,
  matchOfficialIndex,
...
export type { CommunityRegistryDescriptor } from "@/lib/shadcn/registry-search";
