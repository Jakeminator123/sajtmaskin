...
export const FEATURED_BLOCKS = [
  {
    id: "login",
    titleSv: "Inloggningssidor",
    descriptionSv: "Professionella inloggningsformulär",
    blocks: ["login-01", "login-02", "login-03", "login-04", "login-05"],
  },
  {
    id: "dashboard",
    titleSv: "Kontrollpaneler",
    descriptionSv: "Moderna dashboard-layouts",
    blocks: ["dashboard-01"],
  },
  {
    id: "sidebar",
    titleSv: "Sidofält",
    descriptionSv: "Navigeringssidofält",
    blocks: ["sidebar-01", "sidebar-02", "sidebar-03", "sidebar-04", "sidebar-05"],
  },
  {
    id: "charts",
    titleSv: "Diagram",
