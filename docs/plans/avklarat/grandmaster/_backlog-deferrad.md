...
| Arkivera källdokument | Dump-MD (`deep-research-report.md`, `2026-06-17-cleanup-forenkling-handoff.md`) låg i `_parkering/` efter 2026-06-21; **raderade 2026-08-10** (git-historik). "Controlled Aggression" = ingen separat fil. | **Klar 2026-06-21**; filer borta 2026-08-10 |
