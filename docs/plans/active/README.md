...
| Sanering och uppdelning (10 steg) | [`2026-08-01-sanering-och-uppdelning/00-master-plan.md`](2026-08-01-sanering-och-uppdelning/00-master-plan.md) | Steg 0–3 levererade 2026-08-01 (mergestyret, sex false-green-fixar #712–#725, Redis-domänblocken #714, devDeps #717); steg 4 våg 1–2 (#713, #721) och tre megafiler (#722, #724, #727) klara. Routern släpade mot detaljfilerna till 2026-08-05 — status per steg står nu i master-planens tabell | **Steg 4 våg 3** (archived/ + snapshots) och fler megafiler ur [`04-megafiler.md`](2026-08-01-sanering-och-uppdelning/04-megafiler.md); exportytan (spår C) tas domänvis. Historik-omskrivningen (steg 8) och `_parkering/`-raderingen kräver ägar-OK |
