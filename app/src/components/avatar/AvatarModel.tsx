...
// Preload only commonly used animations (reduces initial load)
// Other animations will be loaded on-demand when needed
const PRELOAD_ANIMATIONS: AvatarAnimation[] = ["idle", "talk", "talk_hands"];
PRELOAD_ANIMATIONS.forEach((anim) => {
  useGLTF.preload(ANIMATION_FILES[anim]);
});
