 ...
 * Canonical repo path: e2e/vercel-templates/scrape-catalog.spec.ts (tracked in git).
 * Legacy copy may exist under vercel_templates_levels/ (gitignored) — keep in sync or delete locally.
 *
 * Two modes:
 *
