# Arkivnotis: post-exit kö (2026-03)

**Status:** Kö-dokumenten lever **inte** längre som en separat katalog här med full filuppsättning — de samlades i **`docs/plans/active/MASTER-ALLT-KVAR.md`** med levande detaljer kvar under **`docs/plans/active/queue/`**.

**Historik:** Tidigare fanns lokala ögonblickskopior under `docs/plans/post-exit-queue-2026-03/` och liknande; innehållet var **identiskt** med `active/queue/*` och dubletter **raderades** för att undvika dubbel sanning.
