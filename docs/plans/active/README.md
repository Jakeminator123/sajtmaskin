...
|---|---|---|
| Publik `/analys` via audit | Lead magnet på `/analys` + `POST /api/analys`, mergad till preview i #1471. Gratisvägen kör Luna/basic utan web_search. Inloggad `/api/audit` behåller Sol. Widget-spåret (punkt 2 av fem) är struket. Kvar av de fem: inline bild i mejl/DM, PRV T-1, nyemission, DNS-byte — [`resterande-fyra-spar.md`](2026-09-18-analys-audit-leadmagnet/resterande-fyra-spar.md). Kvar i detta spår: index/sitemap (B2) och partner `?mode=audit` (B4). | [`2026-09-18-analys-audit-leadmagnet/00-master-plan.md`](2026-09-18-analys-audit-leadmagnet/00-master-plan.md) |
