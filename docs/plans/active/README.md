...
| Armerad autonomi + generationskort | Kod på GitHub, inte mergad. A1 [#1495](https://github.com/Jakeminator123/sajtmaskin/pull/1495), A2 [#1498](https://github.com/Jakeminator123/sajtmaskin/pull/1498) (beroende A1→A2, gemensamma hook-/meddelandefiler), B1 [#1497](https://github.com/Jakeminator123/sajtmaskin/pull/1497), C1 [#1496](https://github.com/Jakeminator123/sajtmaskin/pull/1496). D1 parkerad `SM-072`. Korrigeringsrunda före merge: väckning-efter-fel, diagnostik utan svarstext, tomläge+avhugget, kvot för osynligt svar. | [`2026-09-19-openclaw-armering-och-generationskort/00-master-plan.md`](2026-09-19-openclaw-armering-och-generationskort/00-master-plan.md) |
