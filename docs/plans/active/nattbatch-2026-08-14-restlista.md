...
| Rad | Läge |
|---|---|
| Djupmedvetet sidtak (nivå 1+2 räknas, tak 4) | Blockerad: ny produktförmåga, kräver uttryckligt OK |
| `SM-040` kolonlistans `och`/`and` | Blockerad: ägaren måste välja vilken felriktning parsern ska göra — `Terms and Conditions` kan bli en sida eller två och en regex kan inte veta vilket |
