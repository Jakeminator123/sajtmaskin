...
| Backoffice (Byggstenar + stringens-städ) | [`2026-07-24-backoffice-byggstenar/00-master-plan.md`](2026-07-24-backoffice-byggstenar/00-master-plan.md) | **Fas A–C + baseline-backup levererade** (#615, #640, #649, #654) och P2-1/P2-3 klara (#647, #650). Kvar: Fas C:s manuella UI-varv (okört acceptanskriterium), Fas D + P2-2/P2-4/P2-5/P2-6 | **Fas C:s UI-varv** (skapa → validera → radera → bekräfta snapshot; statiska tester når inte renderingsfel), sedan **Fas D** (AI-modellval via manifestet — förslaget godkänt 2026-07-28, ändrar beteende och körs därför sist) |
