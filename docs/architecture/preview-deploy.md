...
**Öppet / senare:** adapters för vissa integrationer, GitHub-export som sekundär väg, ev. vidare shim-förenkling — se problemområdena i [`../../5-steg.txt`](../../5-steg.txt) och den separata problemfilen i `övrigt/`.
