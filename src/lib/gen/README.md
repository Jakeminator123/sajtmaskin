...
Sajtmaskin's own code generation engine. Uses OpenAI models (gpt-5.3-codex for Lagom/pro, gpt-5.4 max) via AI SDK to generate Next.js/React sites from prompts. Replaces v0 Platform API as the default path.
