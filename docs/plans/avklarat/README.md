...
Åtta plan-filer levererade och konsoliderade enligt [`../active/parallel-execution-2026-04.md`](../active/parallel-execution-2026-04.md):
...
| [`P22-followup-flow-optimization.md`](./P22-followup-flow-optimization.md) | Hård `forceDeepBrief`-guard på follow-up, `lockedVariantForFollowUp`, `inheritQualityTargetFromPriorVersion`, `classifyFollowUpIntentWithLlmFallback`. Caller-wiring kvar i `P22b`. |
...
| [`P25-builder-ui-and-csp-hygiene.md`](./P25-builder-ui-and-csp-hygiene.md) | Mixpanel-allowlist i CSP, mjuk avatar-offline-state istället för error-toast. Tooltip + overlay-rendering kvar i `P25b`. |
