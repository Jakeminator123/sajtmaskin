...
<!-- source-fingerprint: config/env-policy.json sha256:13815e8d3e199eca -->
...
| `OPENCLAW_MODEL_ROUTING_ENABLED`                     | `optional_runtime`     | `development`, `preview`, `production` | No            | No           |
...
| `SAJTMASKIN_CUSTOMER_DOMAIN_WRITES`                  | `optional_runtime`     | `development`, `preview`, `production` | No            | No           |
...
| `SAJTMASKIN_DISABLE_SERVER_AUTO_BRIEF`               | `environment_specific` | `development`, `preview`, `production` | No            | No           |
...
| `SAJTMASKIN_LIVE_REVIEW`                             | `environment_specific` | `preview`, `production`                | No            | Yes          |
| `SAJTMASKIN_LIVE_REVIEW_AUTO_GRANT`                  | `environment_specific` | `preview`, `production`                | No            | Yes          |
