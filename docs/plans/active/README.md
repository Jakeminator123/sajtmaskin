...
| Verifieringsflöde + inspector | `SM-072` (`/tmp`-svält dödar postcheck) och `SM-073` (ostämplad bridge-injektion dödar inspektorn) bevisade 2026-08-31 med prod-logg + live-repro. Klientlindringar landade; host-fix, prod-verifiering och `SM-070`-beslut kvar — se checklistan. | [`2026-09-01-verifieringsflode-och-inspector/00-master-plan.md`](2026-09-01-verifieringsflode-och-inspector/00-master-plan.md) |
