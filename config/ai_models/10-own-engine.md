...
- **`codex`** är en **egen** byggprofil (standardmodell `gpt-5.1-codex-max` enligt manifest) — alltså inte samma som `max`. Använd sparsamt när du uttryckligen vill tunga kodmodeller; vardagsläge för stark resonemangsmodell är `max` / GPT-5.4.
