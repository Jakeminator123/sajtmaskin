...
2. **Three** parallel `Task` calls: `explore`, `readonly: true`, `model: cursor-grok-4.5-high` (scan role — canonical slugs in [`.cursor/README.md § Modellval för subagenter`](../../README.md#modellval-för-subagenter-kanonisk-tabell)).
