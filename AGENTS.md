...
- **Flera agenter / parallellt:** [`docs/contributing/agent-workflows.md`](docs/contributing/agent-workflows.md) § *Flera agenter* — spår A (städ/docs) vs spår B (`src/lib/gen/*`, `src/lib/providers/own-engine/*`, prompt/runtime).
