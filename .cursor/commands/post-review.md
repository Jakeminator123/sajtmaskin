...
4. Starta read-only subagenter sparsamt:
   ...
   - Använd modell `composer-2.5-fast` om en explicit modell väljs (scan-rollen i [`.cursor/README.md § Modellval för subagenter`](../README.md#modellval-för-subagenter-kanonisk-tabell)).
