...
describe("hook CLI contract", () => {
  ...
  it.each([
    ...
    [".cursor/hooks/worktree-force-guard.mjs", "timeout 1.5 git fetch origin JAKOB_BRA:JAKOB_BRA", "deny"],
    [".cursor/hooks/worktree-force-guard.mjs", "/usr/bin/timeout 10 git fetch origin JAKOB_BRA:JAKOB_BRA", "deny"],
