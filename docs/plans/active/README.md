...
| Dossier-förenkling i etapper | [`2026-08-06-dossier-forenkling/00-master-plan.md`](2026-08-06-dossier-forenkling/00-master-plan.md) | Helhetsdom 2026-08-06: modellen behålls, poolen bantas. Fix-PR (#828), etapp 1 (#831, pool 27 → 23), etapp 2 (#832, `subscriptions`-beroendet borta, pool 22) mergade; etapp 3 (databassyskonen parkerade + `SM-004`/`SM-006` fixade, pool 20) klar i branch | Etapp 3-PR:en genom merge-grinden, sedan etapp 4 (AI-familjen) — referenskarta står i planen |
