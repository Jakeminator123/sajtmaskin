...
|---|---|---|
| GitHub/ZIP-import rester | PR2 bilder/fonts landad på preview via #1461 (`7c606b11`); #1446 stängd. Kvar: server-side idempotens och privat live-smoke. Rör inte latch/SSRF/auth. | [`2026-09-17-github-zip-import-rester/00-master-plan.md`](2026-09-17-github-zip-import-rester/00-master-plan.md) |
| SEO-landningssidor | Organisk kanal via vanliga App Router-sidor. Alla tio poster är `ready` i registret på preview `13843edc` (#1437, #1443, #1448–#1457). Stale Relaterat-copy rättad i #1467. Det är inte Production eller indexering. Beställ inte borttagning av Relaterat-länkar till mål som nu är färdiga. Ingen promote. | [`2026-09-16-seo-landningssidor/00-master-plan.md`](2026-09-16-seo-landningssidor/00-master-plan.md) |
...
| Inspiration, kvitto och komposition | Förfina befintligt källkvitto (bild vs utdrag), dynamisk Quality Bar/research och addenda-urval. Statisk 03 är **landad** i #1464 på preview. Öppna inte disabled addenda. Ingen A–D-kod förrän A ger belägg. | [`2026-09-17-inspiration-kvitto-och-komposition/00-master-plan.md`](2026-09-17-inspiration-kvitto-och-komposition/00-master-plan.md) |
