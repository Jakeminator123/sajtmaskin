...
import {
  str,
  strList,
  extractCapabilityHintLines,
  buildShadcnToolkitSummary,
  formatThemeTokenLines,
} from "./system-prompt/helpers";
import type {
  Brief,
  MediaCatalogItem,
...
// Budget:  ./system-prompt/budget.ts
// Helpers: ./system-prompt/helpers.ts (str/strList, capability-hints,
//          shadcn toolkit passthrough, theme-token rendering)
// Compose: ./system-prompt/compose.ts (static core loader + final system
//          prompt composition)
// ═══════════════════════════════════════════════════════════════════════════
