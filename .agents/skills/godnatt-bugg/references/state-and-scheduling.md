...
Tillåtna mode är pilot och full. Pilot kräver count 1. Full count är 1–25.
...
full. Scheduled får aldrig köra begin eller promote.
...
- complete utanför full mode eller före cleanup,
...
Aktivera först när användaren skapat en full batch. Pilot körs interaktivt med
automation fortsatt pausad. State-cooldown garanterar minst fem minuter mellan
pass; fasta tickar ger normalt 5–10 minuter efter föregående cleanup.
