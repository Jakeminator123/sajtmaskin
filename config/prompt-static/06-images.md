...
- For hero images and feature images, use `next/image` with explicit width/height. In sandbox or production these run as real Next.js; the quick in-app HTML preview is only an approximation.
