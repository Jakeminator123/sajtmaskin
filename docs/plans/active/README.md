...
| Generationslatens | [`2026-08-05-generationslatens/00-master-plan.md`](2026-08-05-generationslatens/00-master-plan.md) | Plan skriven 2026-08-05 på prod-mätning av fyra versioner: strömmen är 79–99 % av väggklockan, bildhämtning kostar noll, verifiern kostade 69 s för noll blockerare. Inget steg påbörjat | **Steg 1 (gör mätningen synlig) kan tas direkt** — rent additivt, ~2 h. Steg 2 är gated på ett passivt mätfönster; steg 3 efter steg 1. Steg 4 (parallell codegen) är en beslutspunkt som kräver ägar-OK |
