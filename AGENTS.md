...
- **Plattform:** [`bash-och-pwsh.mdc`](.cursor/rules/bash-och-pwsh.mdc) (kort pwsh-stub; felkatalog: [`bash-och-pwsh-fel.mdc`](.cursor/rules/bash-och-pwsh-fel.mdc)), [`rtk-terminal.mdc`](.cursor/rules/rtk-terminal.mdc) (RTK komprimerar Shell-output — bifoga vid behov), [`unicode-regex.mdc`](.cursor/rules/unicode-regex.mdc)
...
- **MVP-fas:** [`mvp-scope-freeze.mdc`](.cursor/rules/mvp-scope-freeze.mdc) — stabilitet före coolhet; varna + fråga innan nya features/ytor
...
Canonical merge-grind (7-min-fönster, `merge:ready`-ordning, proportionalitet, protected paths, bot-fyndsvep, Codex-triage, author-is-merger): [`pr-merge.mdc`](.cursor/rules/pr-merge.mdc) · [`git.mdc`](.cursor/rules/git.mdc). Bakgrund och incidenter: [`docs/runbooks/pr-merge-gate.md`](docs/runbooks/pr-merge-gate.md).
