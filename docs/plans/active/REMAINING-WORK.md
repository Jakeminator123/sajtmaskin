...
|--------|----------------|
| Kritik (**K-018**, **K-019** öppna; K-007/K-009/K-008/K-014 stängda) | [`kritik-consolidated-open-items.md`](./kritik-consolidated-open-items.md) · FAQ [`queue/FRAGOR-SVAR-FAQ.md`](./queue/FRAGOR-SVAR-FAQ.md) |
...
**Senast synkad:** 2026-03-26 — **K-007 [x], K-009 [x]/[N/A]** i kritik-tabellen; öppna K-rader: **K-018**, **K-019**. [`SAJTMASKIN-EXECUTION-PLAN.md`](./SAJTMASKIN-EXECUTION-PLAN.md) §1 (K-007/K-009 tabeller arkiverade under `avklarat/2026-03-26-execution-plan-K007-K009-closed.md`); [`MASTER-ALLT-KVAR.md`](./MASTER-ALLT-KVAR.md); `KORFIL` → MASTER.
