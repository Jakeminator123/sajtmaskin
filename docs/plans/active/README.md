...
|---|---|---|
| Publik `/analys` via audit | Lead magnet på `/analys` + `POST /api/analys`. Gratisvägen kör Luna/basic utan web_search och får en trimmad publik projektion; inloggad `/api/audit` behåller Sol. Spår 1 av de fem kundanskaffningsspåren är struket. Kvar: ägarbeslut om index/sitemap (B2) och partner `?mode=audit` (B4). Draft-PR mot preview. | [`2026-09-18-analys-audit-leadmagnet/00-master-plan.md`](2026-09-18-analys-audit-leadmagnet/00-master-plan.md) |
