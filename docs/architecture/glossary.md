...
| 2026-04-13 | Phase 1 deep consolidation (v11c): `domain-inference.ts` läser nu `config/domain-rules.json` (editerbar SV+EN keyword-lista per domän). Backoffice visar domänregler. `prompt-heuristics.ts` är delad ordlistekälla för structured-prompt-heuristiker. |
