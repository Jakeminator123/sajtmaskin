...
- **Storstäd + agent-handoff:** [`docs/plans/active/STORDSTAD-repo-kod-databas.md`](docs/plans/active/STORDSTAD-repo-kod-databas.md) (pass-logg, skyddade sökvägar, kopieringsbar startrad). För städ i en **worktree**: en Cursor-root åt gången — se planens § Handoff *Cursor: var du arbetar* och valfritt `stordstad-only.code-workspace` i den checkouten.
