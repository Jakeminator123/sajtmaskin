...
| Generationslatens | [`2026-08-05-generationslatens/00-master-plan.md`](2026-08-05-generationslatens/00-master-plan.md) | Plan skriven 2026-08-05 på prod-mätning av fyra versioner: strömmen är 79–99 % av väggklockan, bildhämtning kostar noll, och verifierns 69 s var trippel-gatead av BuildSpec-klassningen (inte av autofix-risk — bugbot-fynd korrigerat före merge). Inget steg påbörjat | **Steg 1 (gör mätningen synlig) kan tas direkt** — rent additivt, ~2 h. Steg 2 (BuildSpec-klassningen) efter steg 1. Steg 3 (verifiern ur F2) är ett ägarbeslut, steg 4 (parallell codegen) en beslutspunkt som kräver ägar-OK |
