...
| 2026-07-30 | Telemetri/credits   | En generationsrad beskriver **utfallet, inte det värsta ögonblicket**: en återhämtad 429 får inte skriva `success=false`, och en awaiting-input-runda debiteras lika oavsett blipp (`providerFault` scopas per försök)                                  | git: `docs/plans/avklarat/bug-swarm/backlog-arkiv-2026-07-25.md` → de två `providerFault`-raderna (fil borttagen 2026-08-10)                                                                   |
