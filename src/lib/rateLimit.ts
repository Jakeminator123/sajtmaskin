...
export const RATE_LIMITS: Record<string, RateLimitConfig> = {
  ...
  "ai:intake-summary": { maxRequests: 20, windowMs: 60 * 1000 },
  "ai:suggest-pages": { maxRequests: 15, windowMs: 60 * 1000 },
  "ai:classify-intent": { maxRequests: 30, windowMs: 60 * 1000 },
  "ai:spec": { maxRequests: 15, windowMs: 60 * 1000 },
