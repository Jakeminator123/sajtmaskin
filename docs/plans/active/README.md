...
| Prod-körningens fynd — fokus dossiers | [`2026-08-05-prodkorning-dossiers/00-master-plan.md`](2026-08-05-prodkorning-dossiers/00-master-plan.md) | Diagnos skriven 2026-08-05 kväll efter hel kundresa i prod (F2 → F3) + full `/logg`-korsreferens. Fem dossier-defekter ([`01`](2026-08-05-prodkorning-dossiers/01-dossiers.md)), sex pipeline-defekter ([`02`](2026-08-05-prodkorning-dossiers/02-defekter-pipeline.md)), åtta UX-punkter från ägaren ([`03`](2026-08-05-prodkorning-dossiers/03-ux-onskemal.md)). Rotorsaker filverifierade. Diagnosen är källan bakom dossier-förenklingens PR-serie nedan | **Kvar av dossier-spåret:** auto-repair-undertryckandet (`01` § A4) och F3:s `package.json`-kontrakt (§ A3) — `01` § A1 (MapLibre) levererades i #828. `02` (OpenClaw auto-send § B1, postcheck-racet § B2) och `03` (ägarens UX-punkter) är oprioriterade och kräver ägarens go per punkt (MVP-frys) |
| Dossier-förenkling i etapper | [`2026-08-06-dossier-forenkling/00-master-plan.md`](2026-08-06-dossier-forenkling/00-master-plan.md) | Helhetsdom 2026-08-06: modellen behålls, poolen bantas. Fix-PR (#828), etapp 1 (#831, pool 27 → 23), etapp 2 (#832, `subscriptions`-beroendet borta, pool 22) och etapp 3 (#833, databassyskonen parkerade + `SM-004`/`SM-006` fixade, pool 20) mergade | Etapp 4 (AI-familjen: `ai-tool-calling-chat` + `rag-chat`) är kartlagd men ej påbörjad — referenskarta står i planen |
