...
| K-016 | `27pct-w`, `31pct-t` | `chat-area.tsx`: del 1–3 utbrutna (wireframe, radar/LH, tech+integration+how-it-works-fallback); **kvar:** `FeatureCard`, `FeatureModal`, huvud-`ChatArea` | refaktor | låg–medel | [ ] |
