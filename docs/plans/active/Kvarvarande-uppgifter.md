...
|---|--------|-------------|------|---------|
| 1 | UX (P25b-rest) | VersionHistory-tooltips/statuslabels ("Verifierar"/"Fel"/"Publicerad") + `VersionMismatchOverlayPayload` overlay-rendering i `PreviewPanelFrame.tsx`. | Låg | Visuell verifiering — [SAJ-23](https://linear.app/sajtmaskin/issue/SAJ-23) |
