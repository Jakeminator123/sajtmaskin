...
import { LandingHowPageSections } from "@/components/landing-v2/landing-how-page-sections";
import { SiteBackground } from "@/components/layout/site-background";

export function HurDetFungerarContent() {
            ...
            <section className="px-6 pt-16 pb-6 md:pt-24 text-center">
              <div className="max-w-3xl mx-auto">
                ...
                <h1 className="text-3xl md:text-5xl text-foreground mb-4 font-(--font-heading) tracking-tight text-balance leading-[1.1]">
                  Fr&aring;n id&eacute; till publicerad sajt
                </h1>
                <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed text-pretty">
                  Stegen, kvaliteten och integrationerna bakom Sajtmaskin &mdash; samlade h&auml;r
                  s&aring; startsidan kan vara ren och fokuserad.
                </p>
