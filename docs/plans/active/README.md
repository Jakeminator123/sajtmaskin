...
| Builder-UI från prod-observation | [`2026-07-30-builder-ui-observation/`](2026-07-30-builder-ui-observation/00-master-plan.md) | **Ny 2026-07-30**, inget påbörjat. Nio observationer (N1–N9) från en live prod-körning, uppdelade i fyra oberoende uppgiftsfiler | Fem öppna ägarfrågor (Ö1–Ö5) i masterplanen blockerar delar av 01 och 03. Fil 04 börjar med en mätning, inte kod |
