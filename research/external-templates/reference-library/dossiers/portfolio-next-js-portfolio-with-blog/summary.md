...
- Verdict: valid
- Quality score: 96
- Scaffold families: portfolio, app-shell, dashboard
- Repo: https://github.com/vercel/examples
- Demo: https://portfolio-blog-starter.vercel.app

Next.js Portfolio with Blog is a Portfolio reference with verified Next.js codebase, App Router structure, dashboard shell patterns. Verdict: valid.
