...
| Dossier-förenkling i etapper | [`2026-08-06-dossier-forenkling/00-master-plan.md`](2026-08-06-dossier-forenkling/00-master-plan.md) | Helhetsdom 2026-08-06: modellen behålls, poolen bantas. Fix-PR (MapLibre + soft-acceptans + F3-antisuggestion + `SM-023`–`SM-026`), etapp 1 (fyra hard-dossiers parkerade, pool 27 → 23) och etapp 2 (paddle-billing + `subscriptions` parkerade — systemets enda dossier-beroende borta, pool 23 → 22) levererade i PR-serien | Etapp 3 (databassyskonen) och etapp 4 (AI-familjen) kvar — exakta referenskartor står i planen |
