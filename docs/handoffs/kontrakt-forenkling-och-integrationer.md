...
- Om ni behåller `awaitingInput` för **edge cases**: dokumentera att nästa [`POST .../stream`](../../src/app/api/v0/chats/[chatId]/stream/route.ts) **återinträder** i kedjan (redan så — se external review).
...
*Handoff skapad för own-engine-upprustning. Se `v0-fasning-och-forenkling.md`, `llm-kedja-och-generationskvalitet.md` och `autofix-och-quality-gates.md`.*
