...
- **Levande backlog:** [`docs/plans/active/kritik-consolidated-open-items.md`](../active/kritik-consolidated-open-items.md) (master-tabell; [kritik-derived-backlog.md](../active/kritik-derived-backlog.md) = pekare)
