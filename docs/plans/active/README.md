...
| Armerad autonomi + generationskort | Fyra spår ur preview-körningen 2026-09-19 (`a0b134d9`). A1: armeringen skapar mandat men första builder-sändningen startar aldrig. A2: tom/avhuggen ström lämnar evig tänkprick och orsaken är obevisad — mät före fix. B1: init och auto-reparation får samma rubrik. C1: live-review-bilderna når browsern men renderas inte. D1 (Chromium) är parkerad `SM-072`-residual. Utredning klar, kod inte påbörjad. | [`2026-09-19-openclaw-armering-och-generationskort/00-master-plan.md`](2026-09-19-openclaw-armering-och-generationskort/00-master-plan.md) |
