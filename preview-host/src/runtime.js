 ...
 *
 * Vilket värde som helst utanför `/data` återskapar exakt den bugg
...
function sanitizedEnv(overrides = {}) {
  ...
  for (const [key, value] of Object.entries(process.env)) {
    ...
    if (
      ...
      // rootfs:en. Janitorn städar bara `/data`, så disken fylls tyst tills
      // varje `npm install` dör med ENOSPC — medan volymen har gott om plats.
      // Ett värde inuti `/data` respekteras fortfarande; allt annat ignoreras
      // till förmån för den beräknade sökvägen.
