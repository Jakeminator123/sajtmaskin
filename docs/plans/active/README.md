...
|---|---|---|
| Kundens adress och portal | C1/C2/C3e1/A2/A3/B1/D1 är kod på preview. Flaggor av. A1 HTTPS-test, A4-pilot, D2/D3 (#1385) och kundaktivering återstår. Ingen produktionspromote. | [`2026-09-14-kundens-adress-och-portal/00-master-plan.md`](2026-09-14-kundens-adress-och-portal/00-master-plan.md) |
