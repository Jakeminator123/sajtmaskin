...
| `docs/plans/avklarat/stort-framsteg-2026-07-03/2026-07-03_1058.md`        | Rå sessionsnotis                               | Slutrapport + git                           | DELETE AFTER REFERENCE MIGRATION | Medel | Slutrapporten länkar filen; migrera länken till git-/PR-historik innan deletion                       | 3      |
