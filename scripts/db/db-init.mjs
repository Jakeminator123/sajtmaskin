...
const setupQueries = [
  ...
  `CREATE TABLE IF NOT EXISTS app_projects (
    ...
    published_slug TEXT,
    branded_domain TEXT,
    branded_domain_verified_at TIMESTAMPTZ,
    branded_domain_checked_at TIMESTAMPTZ,
    custom_domain TEXT,
...
const schemaQueries = [
  ...
  // Innehållsrevision: genererad kolumn på engine_versions (skapas ovan i
  // schemaQueries). generation_telemetry.files_revision + indexet hör till
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS app_projects_published_slug_unique ON app_projects(published_slug) WHERE published_slug IS NOT NULL`,
  `CREATE UNIQUE INDEX IF NOT EXISTS app_projects_custom_domain_unique ON app_projects(custom_domain) WHERE custom_domain IS NOT NULL`,
  `CREATE UNIQUE INDEX IF NOT EXISTS app_projects_branded_domain_unique ON app_projects(branded_domain) WHERE branded_domain IS NOT NULL`,
