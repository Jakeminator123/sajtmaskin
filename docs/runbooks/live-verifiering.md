...
| Fly-host live efter #1445 | `GET https://vm-fly-jakem.fly.dev/health` 2026-09-17 ~02:56 UTC | **PARTIAL** — `ok:true`, `release.status=identified` | `release.sourceSha` var `d37011919` (promote #1394, 2026-09-15). Det är inte #1445 `a90d9da43`. Jailen är därför inte live. Image-id per maskin lästes inte. `ok:true` räcker inte som funktions- eller isoleringsbevis. |
