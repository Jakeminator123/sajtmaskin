...
- [`src/app/api/audit/route.ts`](../../src/app/api/audit/route.ts) (inloggad audit; Responses + valfritt web search)
- [`src/app/api/analys/route.ts`](../../src/app/api/analys/route.ts) (publik `/analys`; samma `runWebsiteAudit`-motor)
